            ...
            <View key={index} className="p-4 bg-bgBlue m-5 rounded-2xl">
              <View className="flex-row flex-wrap">
                <View style={{ width: '50%', padding: 8 }}>
                  <Text style={{ fontSize: Hp(1.8) }} className="text-gray-500">{t('container_number')}</Text>
                  <Text style={{ fontSize: Hp(2) }} className="text-black">{items.container_number}</Text>
                </View>
                <View style={{ width: '50%', padding: 8 }}>
                  <Text style={{ fontSize: Hp(1.8) }} className="text-gray-500">{t('date')}</Text>
                  <Text style={{ fontSize: Hp(2) }} className="text-black">{items.date}</Text>
                </View>
                <View style={{ width: '50%', padding: 8 }}>
                  <Text style={{ fontSize: Hp(1.8) }} className="text-gray-500">{t('created')}</Text>
                  <Text style={{ fontSize: Hp(2) }} className="text-black">{items.created_at}</Text>
                </View>
                <View style={{ width: '50%', padding: 8 }}>
                  <Text style={{ fontSize: Hp(1.8) }} className="text-gray-500">{t('responsible_person')}</Text>
                  <Text style={{ fontSize: Hp(2) }} className="text-black">{items.responsible_person}</Text>
                </View>
                <View style={{ width: '50%', padding: 8 }}>
                  <Text style={{ fontSize: Hp(1.8) }} className="text-gray-500">{t('packing_address')}</Text>
                  <Text style={{ fontSize: Hp(2) }} className="text-black">{items.packing_address}</Text>
                </View>
              </View>
              <TouchableOpacity className="bg-primary py-3 w-[50%] rounded-full items-center mt-5" onPress={() => downloadPdf(items.id)}>
                {
                  loading === items.id ? (
                    ...
                    <Text style={{ fontSize: Hp(1.8) }} className="text-white font-bold">Download PDF</Text>
                  )
                }
              </TouchableOpacity>
            </View>
